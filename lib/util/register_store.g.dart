...
mixin _$RegisterStore on RegisterStoreBase, Store {
  final _$isLoginLoadingAtom = Atom(name: 'RegisterStoreBase.isLoginLoading');
  ...
  final _$loginScaffoldKeyAtom =
      Atom(name: 'RegisterStoreBase.loginScaffoldKey');
  ...
  final _$otpScaffoldKeyAtom = Atom(name: 'RegisterStoreBase.otpScaffoldKey');
  ...
  final _$firebaseUserAtom = Atom(name: 'RegisterStoreBase.firebaseUser');
  ...
  Future<void> validateOtpAndLogin(
      ...
      String mobile,
      String user_image) {
    return _$validateOtpAndLoginAsyncAction.run(() => super.validateOtpAndLogin(
        context,
        smsCode,
        user_id,
        email,
